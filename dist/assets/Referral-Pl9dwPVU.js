import{d as n,u as I,r as i,j as e,S as j,o as h,e as C,C as S,z as l}from"./index-20cc1d6t.js";import{A as U}from"./award-CPXRUCty.js";import{S as D}from"./share-2-DBP4jAUS.js";import{S as $}from"./shopping-bag-BwewnCNZ.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=n("Facebook",[["path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z",key:"1jg4f8"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=n("Gift",[["rect",{x:"3",y:"8",width:"18",height:"4",rx:"1",key:"bkv52"}],["path",{d:"M12 8v13",key:"1c76mn"}],["path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7",key:"6wjy6b"}],["path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5",key:"1ihvrl"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=n("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=n("MessageCircle",[["path",{d:"M7.9 20A9 9 0 1 0 4 16.1L2 22Z",key:"vv11sd"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=n("Twitter",[["path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z",key:"pff0z6"}]]),X=()=>{const{user:s}=I(),[g,p]=i.useState(!1),[c,b]=i.useState(0),[m,u]=i.useState(!1),[f]=i.useState({total_points:0,total_referrals:0,recent_transactions:[]}),d=f.recent_transactions||[],N=f.total_referrals||0,v=null;i.useEffect(()=>{b((s==null?void 0:s.referralPoints)||0)},[s==null?void 0:s.id,s==null?void 0:s.referralPoints]),i.useEffect(()=>{if(m){const t=setTimeout(()=>u(!1),1e3);return()=>clearTimeout(t)}},[m]);const w=async()=>{try{const t=(s==null?void 0:s.referralCode)||"";if(!t){l.error("Δεν υπάρχει κωδικός παραπομπής");return}await navigator.clipboard.writeText(t),l.success("Ο κωδικός αντιγράφηκε επιτυχώς!")}catch{l.error("Σφάλμα κατά την αντιγραφή")}},k=async()=>{const t=(s==null?void 0:s.referralCode)||"";if(!t){l.error("Δεν υπάρχει κωδικός παραπομπής");return}if(navigator.share)try{await navigator.share({title:"Get Fit - Κωδικός Παραπομπής",text:`Γίνετε μέλος στο Get Fit χρησιμοποιώντας τον κωδικό παραπομπής μου: ${t}`,url:`https://freegym.com/register?ref=${t}`})}catch(a){console.log("Error sharing:",a)}else p(!0)},o=t=>{const a=(s==null?void 0:s.referralCode)||"";if(!a){l.error("Δεν υπάρχει κωδικός παραπομπής");return}const y=`Γίνετε μέλος στο Get Fit χρησιμοποιώντας τον κωδικό παραπομπής μου: ${a}`,x=`https://freegym.com/register?ref=${a}`;let r="";switch(t){case"facebook":r=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(x)}`;break;case"instagram":r="https://www.instagram.com/";break;case"twitter":r=`https://twitter.com/intent/tweet?text=${encodeURIComponent(y)}&url=${encodeURIComponent(x)}`;break;case"whatsapp":r=`https://wa.me/?text=${encodeURIComponent(y+" "+x)}`;break}r&&(window.open(r,"_blank"),l.success(`Μοιρασμός στο ${t} επιτυχής!`))};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    @keyframes fadeInUp {
      from {
        opacity: 0;
