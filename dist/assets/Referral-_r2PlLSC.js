import{d as i,u as S,r,j as e,S as b,o as h,e as U,C as D,z as l}from"./index-D1F5Dm1t.js";import{getUserReferralStats as R}from"./referralService-DaVLbDt_.js";import{A as M}from"./award-BXkgH5gM.js";import{S as $}from"./share-2-8DoX2ywH.js";/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const L=i("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=i("Facebook",[["path",{d:"M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z",key:"1jg4f8"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=i("Gift",[["rect",{x:"3",y:"8",width:"18",height:"4",rx:"1",key:"bkv52"}],["path",{d:"M12 8v13",key:"1c76mn"}],["path",{d:"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7",key:"6wjy6b"}],["path",{d:"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5",key:"1ihvrl"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _=i("Instagram",[["rect",{width:"20",height:"20",x:"2",y:"2",rx:"5",ry:"5",key:"2e1cvw"}],["path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z",key:"9exkf1"}],["line",{x1:"17.5",x2:"17.51",y1:"6.5",y2:"6.5",key:"r4j83e"}]]);/**
 * @license lucide-react v0.468.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const T=i("Twitter",[["path",{d:"M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z",key:"pff0z6"}]]),H=()=>{const{user:t}=S(),[u,p]=r.useState(!1),[c,f]=r.useState(0),[m,N]=r.useState(!1),[E,y]=r.useState(!0),[j,v]=r.useState({total_points:0,total_referrals:0,recent_transactions:[]}),d=j.recent_transactions||[],w=j.total_referrals||0,k=null;r.useEffect(()=>{(async()=>{if(t!=null&&t.id){y(!0);try{f((t==null?void 0:t.referralPoints)||0);const a=await R(t.id);v(a)}catch(a){console.error("Error loading referral data:",a),f((t==null?void 0:t.referralPoints)||0)}finally{y(!1)}}})()},[t==null?void 0:t.id,t==null?void 0:t.referralPoints]),r.useEffect(()=>{if(m){const s=setTimeout(()=>N(!1),1e3);return()=>clearTimeout(s)}},[m]);const I=async()=>{try{const s=(t==null?void 0:t.referralCode)||"";if(!s){l.error("Δεν υπάρχει κωδικός παραπομπής");return}await navigator.clipboard.writeText(s),l.success("Ο κωδικός αντιγράφηκε επιτυχώς!")}catch{l.error("Σφάλμα κατά την αντιγραφή")}},C=async()=>{const s=(t==null?void 0:t.referralCode)||"";if(!s){l.error("Δεν υπάρχει κωδικός παραπομπής");return}if(navigator.share)try{await navigator.share({title:"Get Fit - Κωδικός Παραπομπής",text:`Γίνετε μέλος στο Get Fit χρησιμοποιώντας τον κωδικό παραπομπής μου: ${s}`,url:`https://freegym.com/register?ref=${s}`})}catch(a){console.log("Error sharing:",a)}else p(!0)},o=s=>{const a=(t==null?void 0:t.referralCode)||"";if(!a){l.error("Δεν υπάρχει κωδικός παραπομπής");return}const g=`Γίνετε μέλος στο Get Fit χρησιμοποιώντας τον κωδικό παραπομπής μου: ${a}`,x=`https://freegym.com/register?ref=${a}`;let n="";switch(s){case"facebook":n=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(x)}`;break;case"instagram":n="https://www.instagram.com/";break;case"twitter":n=`https://twitter.com/intent/tweet?text=${encodeURIComponent(g)}&url=${encodeURIComponent(x)}`;break;case"whatsapp":n=`https://wa.me/?text=${encodeURIComponent(g+" "+x)}`;break}n&&(window.open(n,"_blank"),l.success(`Μοιρασμός στο ${s} επιτυχής!`))};return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
    @keyframes fadeInUp {
      from {
        opacity: 0;
