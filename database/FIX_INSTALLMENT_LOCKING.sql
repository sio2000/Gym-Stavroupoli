...
-- Update the lock_installment function to work with the new columns
...
-- Update the unlock_installment function
...
-- Update the delete_third_installment_permanently function
