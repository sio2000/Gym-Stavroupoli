-- ═══════════════════════════════════════════════════════════════
-- COMPLETE PILATES BOOKING FIX - ALL IN ONE
-- Διορθώνει ΟΛΑ τα issues που βρέθηκαν
-- ═══════════════════════════════════════════════════════════════
...
-- PART 3: Fix RLS Policies για Trainers
-- ═══════════════════════════════════════════════════════════════
...
-- Policy 1: Users + Trainers + Admins can view bookings
...
-- Policy 4: Admins/Secretaries can manage all bookings
...
-- PART 4: Comments για Documentation
-- ═══════════════════════════════════════════════════════════════
...
-- FROM pg_policies 
-- WHERE tablename IN ('pilates_bookings', 'pilates_schedule_slots', 'pilates_deposits')
