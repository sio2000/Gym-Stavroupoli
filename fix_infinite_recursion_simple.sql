-- SIMPLIFIED SAFE FIX FOR INFINITE RECURSION IN USER_PROFILES RLS
-- This version avoids auth schema and focuses on the core fix
...
-- Test the new functions (with a dummy UUID)
SELECT 
    'TEST_RESULT' as audit_type,
    'Testing create_user_profile_safe function' as test_name,
    public.create_user_profile_safe(
...
SELECT 
    'TEST_RESULT' as audit_type,
    'Testing get_user_profile_safe function' as test_name,
    public.get_user_profile_safe('00000000-0000-0000-0000-000000000001'::UUID) as result;
