...
const UltimateInstallmentsTab: React.FC<UltimateInstallmentsTabProps> = ({
  ultimateRequests,
  ultimateLoading,
  ultimateSearchTerm,
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-6 py-3 bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-xl hover:from-orange-700 hover:to-orange-800 transition-all duration-200 disabled:opacity-50 flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105 font-medium"
        >
          {ultimateLoading ? (
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-800 border border-gray-600 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-white placeholder-gray-400 text-lg font-medium"
              />
            </div>
          </div>
          {ultimateSearchTerm && (
      ...
      {ultimateLoading ? (
        ...
        <div className="text-center py-16">
          <div className="bg-gradient-to-br from-orange-600 to-orange-700 rounded-full p-6 w-24 h-24 mx-auto mb-6 shadow-2xl">
        ...
        <div className="grid gap-8">
          {getFilteredUltimateRequests().map((request) => (
            <div key={request.id} className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-600 p-8 hover:shadow-3xl transition-all duration-300 transform hover:scale-102">
                ...
                <div className="flex items-start space-x-6">
                  <div className="relative">
                    {request.user?.profile_photo ? (
                      <div className="w-16 h-16 rounded-2xl overflow-hidden shadow-2xl border-3 border-orange-400">
                        <img 
                        ...
                        />
                        <div className="w-full h-full bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center hidden">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-3 flex-wrap">
                      <span className="inline-flex items-center px-4 py-2 rounded-xl text-sm font-bold bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg">
                        👑 Ultimate Package
                      </span>
                      ...
                      {request.has_installments && (
                        <>
                          <span className="text-gray-400">•</span>
                          <span className="inline-flex items-center px-3 py-1 rounded-xl text-sm font-medium bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg">
                            💳 Με Δόσεις
                          </span>
                        </>
                      )}
              ...
              {request.has_installments && (
                <div className="mt-8 bg-gradient-to-r from-orange-500/20 to-orange-600/20 rounded-2xl p-6 border border-orange-500/30 shadow-xl">
                  ...
                  {/* Total Display */}
                  <div className="mt-6 p-6 bg-gradient-to-r from-orange-500/30 to-orange-600/30 rounded-2xl border border-orange-500/50 shadow-xl">
                    <div className="flex justify-between items-center">
                      <span className="font-bold text-orange-300 text-lg">💰 Σύνολο Δόσεων:</span>
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      ...
                      className="px-8 py-4 bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-2xl hover:from-orange-700 hover:to-orange-800 transition-all duration-200 flex items-center space-x-3 shadow-2xl hover:shadow-3xl transform hover:scale-110 font-bold text-lg"
                    >
...
export default UltimateInstallmentsTab;
