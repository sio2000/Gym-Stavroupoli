      ...
      <div className="bg-gradient-to-r from-gray-800 to-gray-900 shadow-2xl border-b border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center py-4 sm:py-6 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-3 sm:space-x-4">
              <img 
                src="/logo.png" 
                alt="Get Fit Logo" 
                className="h-16 w-16 sm:h-20 sm:w-20 lg:h-32 lg:w-32 rounded-lg object-contain"
              />
              <div>
                ...
                {/* Mobile description */}
                <p className="text-gray-300 mt-1 text-sm sm:hidden">
                  {activeTab === 'scanner' ? '🔍 QR Scanner' : 
                   activeTab === 'membership-requests' ? '📋 Αιτήματα' : 
                   activeTab === 'users-information' ? '👥 Χρήστες' :
                   activeTab === 'personal-training' ? '💪 Personal Training' :
                   '💳 Δόσεις'}
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-2 sm:space-x-4 w-full sm:w-auto">
              {activeTab === 'membership-requests' && (
                <button
                  ...
                  className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 text-sm sm:text-base"
                >
                  <RefreshCw className="h-4 w-4" />
                  <span className="font-medium hidden sm:inline">Ανανέωση</span>
                  <span className="font-medium sm:hidden">⟳</span>
                </button>
              )}
              <button
                onClick={logout}
                className="flex items-center space-x-1 sm:space-x-2 px-3 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-gray-600 to-gray-700 text-white rounded-xl hover:from-gray-700 hover:to-gray-800 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 text-sm sm:text-base"
              >
                <X className="h-4 w-4" />
                <span className="font-medium hidden sm:inline">Αποσύνδεση</span>
                <span className="font-medium sm:hidden">Έξοδος</span>
              </button>
            </div>
          </div>
          ...
          <div className="border-t border-gray-600">
            <nav className="flex flex-wrap gap-1 sm:gap-2 p-1 sm:p-2">
              <button
                onClick={() => setActiveTab('scanner')}
                className={`py-2 sm:py-4 px-3 sm:px-6 rounded-xl font-medium text-xs sm:text-sm transition-all duration-200 transform hover:scale-105 flex-1 sm:flex-none ${
                  activeTab === 'scanner'
              ...
              >
                <div className="flex items-center justify-center space-x-1 sm:space-x-2">
                  ...
                  <span className="hidden sm:inline">📋 Αιτήματα Συνδρομών</span>
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-4 sm:py-8">
        {activeTab === 'scanner' ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
            {/* QR Scanner */}
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-600 p-4 sm:p-6 backdrop-blur-sm">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 flex items-center">
                <span className="text-xl sm:text-2xl mr-2">🔍</span>
                <span className="hidden sm:inline">QR Code Scanner</span>
            ...
            <div className="space-y-4">
              {!isScanning ? (
                <div className="text-center py-8 sm:py-12">
                  <div className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-full p-3 sm:p-4 w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 shadow-lg">
                    <Camera className="h-10 w-10 sm:h-12 sm:w-12 text-white" />
                  </div>
                  <h3 className="text-base sm:text-lg font-medium text-white mb-2">Ξεκινήστε τη σάρωση</h3>
                  <p className="text-gray-300 mb-4 sm:mb-6 text-sm sm:text-base px-4">Πατήστε το κουμπί για να ανοίξετε την κάμερα</p>
                  <button
                    onClick={() => {
                      console.log('🎯 [UI] Start scanning button clicked');
                      startScanning();
                    }}
                    className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 font-medium text-sm sm:text-base"
                  >
                    <Camera className="h-4 w-4 sm:h-5 sm:w-5 inline mr-2" />
                    <span className="hidden sm:inline">Ξεκινήστε σάρωση</span>
                    <span className="sm:hidden">Σάρωση</span>
                  </button>
                </div>
              ) : (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors text-sm sm:text-base"
                    >
                      <XCircle className="h-4 w-4 inline mr-1 sm:mr-2" />
                      <span className="hidden sm:inline">Σταματήστε σάρωση</span>
                      <span className="sm:hidden">Σταμάτα</span>
                    </button>
                    
                    {cameraError && (
                      <button
                        onClick={startScanning}
                        className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base"
                      >
                        <Camera className="h-4 w-4 inline mr-1 sm:mr-2" />
                        <span className="hidden sm:inline">Δοκιμάστε ξανά</span>
                        <span className="sm:hidden">Ξανά</span>
                      </button>
                    )}
                  </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-600 p-4 sm:p-6 backdrop-blur-sm">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 flex items-center">
              <span className="text-xl sm:text-2xl mr-2">📋</span>
              <span className="hidden sm:inline">Πρόσφατες σαρώσεις</span>
              <span className="sm:hidden">Πρόσφατες</span>
            </h2>
            
            {recentScans.length === 0 ? (
              <div className="text-center py-6 sm:py-8">
                <div className="bg-gradient-to-br from-gray-600 to-gray-700 rounded-full p-2 sm:p-3 w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 shadow-lg">
                  <QrCode className="h-8 w-8 sm:h-10 sm:w-10 text-gray-300" />
                </div>
                <p className="text-gray-300 text-sm sm:text-base">Δεν υπάρχουν πρόσφατες σαρώσεις</p>
              </div>
            ) : (
              <div className="space-y-2 sm:space-y-3">
                {recentScans.map((scan, index) => (
                  <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded-xl border border-gray-600 shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-102 space-y-2 sm:space-y-0">
                    <div className="flex items-center space-x-3 sm:space-x-4">
                      <div className={`p-2 sm:p-3 rounded-full shadow-lg ${scan.status === 'approved' ? 'bg-gradient-to-r from-green-500 to-green-600' : 'bg-gradient-to-r from-red-500 to-red-600'}`}>
                    ...
                    <div className="text-left sm:text-right w-full sm:w-auto">
                      ...
                      <p className={`text-xs font-medium px-2 py-1 rounded-full inline-block sm:block ${scan.status === 'approved' ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'}`}>
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-600 p-4 sm:p-6 backdrop-blur-sm">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full sm:w-auto">
              <div className="flex flex-wrap items-center gap-1 sm:gap-2 w-full sm:w-auto" onClick={() => setRequestsPage(1)}>
                <button
                  onClick={() => setRequestPackageFilter('all')}
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors border ${requestPackageFilter === 'all' ? 'bg-gray-700 text-white border-gray-500' : 'bg-gray-800 text-gray-300 hover:text-white border-gray-700'}`}
                >
                  Όλα
                </button>
                <button
                  onClick={() => setRequestPackageFilter('Open Gym')}
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors border ${requestPackageFilter === 'Open Gym' ? 'bg-blue-700 text-white border-blue-500' : 'bg-gray-800 text-gray-300 hover:text-white border-gray-700'}`}
                >
                  <span className="hidden sm:inline">Open Gym</span>
                  <span className="sm:hidden">Gym</span>
                </button>
                <button
                  onClick={() => setRequestPackageFilter('Pilates')}
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors border ${requestPackageFilter === 'Pilates' ? 'bg-purple-700 text-white border-purple-500' : 'bg-gray-800 text-gray-300 hover:text-white border-gray-700'}`}
                >
                  Pilates
                </button>
                <button
                  onClick={() => setRequestPackageFilter('Ultimate')}
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors border ${requestPackageFilter === 'Ultimate' ? 'bg-orange-700 text-white border-orange-500' : 'bg-gray-800 text-gray-300 hover:text-white border-gray-700'}`}
                >
                  <span className="hidden sm:inline">Ultimate</span>
                  <span className="sm:hidden">Ult.</span>
                </button>
                <button
                  onClick={() => setRequestPackageFilter('Installments')}
                  className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors border ${requestPackageFilter === 'Installments' ? 'bg-amber-700 text-white border-amber-500' : 'bg-gray-800 text-gray-300 hover:text-white border-gray-700'}`}
                >
                  Δόσεις
                </button>
              </div>
              <input
                ...
                className="px-3 py-2 rounded-lg text-sm bg-gray-800 text-gray-200 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full sm:w-auto"
              />
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {membershipRequests
                  ...
                  .map((request) => (
                  <div key={`${request.id}-${request.package?.name || 'pkg'}`} className="bg-gradient-to-r from-gray-700 to-gray-800 border border-gray-600 rounded-2xl p-4 sm:p-6 hover:from-gray-600 hover:to-gray-700 transition-all duration-200 shadow-lg hover:shadow-2xl transform hover:scale-102">
                    <div className="flex flex-col sm:flex-row items-start justify-between space-y-4 sm:space-y-0">
                      <div className="flex-1 w-full">
                        <div className="flex items-center space-x-3 sm:space-x-4 mb-4">
                          <div className="flex-shrink-0">
                            {request.user?.profile_photo ? (
                              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl overflow-hidden shadow-lg border-2 border-blue-400">
                                <img 
                          ...
                          <div>
                            <h3 className="font-semibold text-white text-base sm:text-lg">{request.user?.first_name && request.user?.last_name ? `${request.user.first_name} ${request.user.last_name}` : 'Άγνωστος χρήστης'}</h3>
                            <p className="text-xs sm:text-sm text-gray-300">{request.user?.email || 'Δεν υπάρχει email'}</p>
                          </div>
                        </div>
                        
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 mt-4">
                          <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-500/20 to-blue-600/20 rounded-lg p-2 sm:p-3 border border-blue-500/30">
                            <CreditCard className="h-4 w-4 sm:h-5 sm:w-5 text-blue-400" />
                            <span className="text-xs sm:text-sm text-gray-200">
                              <span className="font-medium text-blue-300">Πακέτο:</span> <span className="hidden sm:inline">{request.package?.name || 'Άγνωστο πακέτο'}</span><span className="sm:hidden">{request.package?.name?.split(' ')[0] || 'Άγνωστο'}</span>
                            </span>
                          </div>
                          <div className="flex items-center space-x-2 bg-gradient-to-r from-purple-500/20 to-purple-600/20 rounded-lg p-2 sm:p-3 border border-purple-500/30">
                            <Clock className="h-4 w-4 sm:h-5 sm:w-5 text-purple-400" />
                            <span className="text-xs sm:text-sm text-gray-200">
                              <span className="font-medium text-purple-300">Διάρκεια:</span> <span className="hidden sm:inline">{getDurationLabel(request.duration_type)}</span><span className="sm:hidden">{getDurationLabel(request.duration_type).split(' ')[0]}</span>
                            </span>
                          </div>
                          <div className="flex items-center space-x-2 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-lg p-2 sm:p-3 border border-green-500/30 sm:col-span-2 lg:col-span-1">
                            <Euro className="h-4 w-4 sm:h-5 sm:w-5 text-green-400" />
                            <span className="text-xs sm:text-sm text-gray-200">
                        ...
                        {request.classes_count && request.classes_count > 0 && (
                          <div className="mt-4 p-3 sm:p-4 bg-gradient-to-r from-pink-500/20 to-pink-600/20 border border-pink-500/30 rounded-xl">
                            <div className="flex items-center space-x-2">
                              <span className="text-xl sm:text-2xl">🧘</span>
                              <span className="text-xs sm:text-sm font-medium text-pink-300">
                                <span className="hidden sm:inline">Μαθήματα Pilates: {request.classes_count}</span>
                                <span className="sm:hidden">Pilates: {request.classes_count}</span>
                              </span>
                            </div>
                          </div>
                        )}
                        ...
                        {request.has_installments && (
                          <div className="mt-4 sm:mt-6 bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-orange-200 rounded-2xl shadow-xl overflow-hidden">
                            {/* Header */}
                            <div className="bg-gradient-to-r from-orange-500 to-amber-500 px-4 sm:px-6 py-3 sm:py-4">
                              <h4 className="text-lg sm:text-xl font-bold text-white flex items-center">
                                ...
                                <span className="hidden sm:inline">Διαχείριση Δόσεων - {request.package?.name || 'Συνδρομής'}</span>
                                <span className="sm:hidden">Δόσεις - {request.package?.name?.split(' ')[0] || 'Συνδρομής'}</span>
                              </h4>
                            </div>
                            ...
                            <div className="p-4 sm:p-6">
                              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                                {/* 1η Δόση */}
                                <div className="bg-white rounded-xl shadow-lg border border-orange-100 p-4 sm:p-5 hover:shadow-xl transition-all duration-200">
                                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                                    <h5 className="text-base sm:text-lg font-bold text-orange-800 flex items-center">
                                      <span className="w-6 h-6 sm:w-8 sm:h-8 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">1</span>
                                      <span className="hidden sm:inline">1η Δόση</span>
                                      <span className="sm:hidden">1η</span>
                                    </h5>
                                    {isInstallmentLocked(request, 1) && (
                                      <div className="flex items-center text-orange-600 text-xs sm:text-sm font-medium">
                                        ...
                                        <span className="hidden sm:inline">Κλειδωμένη</span>
                                        <span className="sm:hidden">Κλειδ.</span>
                                      </div>
                                    )}
                                  </div>
                                  ...
                                  <div className="space-y-3 sm:space-y-4">
                                    <div>
                                      <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">💰 Ποσό (€)</label>
                                      <input
                                        type="number"
                                        ...
                                        className={`w-full p-2 sm:p-3 border-2 rounded-xl focus:ring-2 transition-all text-sm ${
                                          isInstallmentLocked(request, 1)
                                    ...
                                    <div>
                                      <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">💳 Τρόπος Πληρωμής</label>
                                      <select
                ...
                <div className="flex items-center justify-center gap-2 sm:gap-3 pt-2">
                  <button
                    ...
                    className={`px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium border ${requestsPage === 1 ? 'opacity-50 cursor-not-allowed bg-gray-700 text-gray-300 border-gray-600' : 'bg-gray-800 text-gray-200 hover:text-white border-gray-700'}`}
                  >
                    <span className="hidden sm:inline">Προηγούμενο</span>
                    <span className="sm:hidden">Προηγ.</span>
                  </button>
                  <span className="text-gray-300 text-xs sm:text-sm">
                    <span className="hidden sm:inline">Σελίδα {requestsPage}</span>
                    <span className="sm:hidden">{requestsPage}</span>
                  </span>
                  <button
                    onClick={() => setRequestsPage(p => p + 1)}
                    className="px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium border bg-gray-800 text-gray-200 hover:text-white border-gray-700"
                  >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-4 sm:space-y-0">
                <div>
                  <h2 className="text-lg sm:text-2xl font-bold mb-2">
                    <span className="hidden sm:inline">💪 Personal Training Πρόγραμμα</span>
                    <span className="sm:hidden">💪 Personal Training</span>
                  </h2>
                  <p className="text-purple-100 text-sm sm:text-base">
                    <span className="hidden sm:inline">Διαχείριση προγραμμάτων προπόνησης</span>
                    <span className="sm:hidden">Διαχείριση προγραμμάτων</span>
                  </p>
                </div>
                <button
                  onClick={() => setShowCreateCodeModal(true)}
                  className="flex items-center space-x-2 sm:space-x-3 px-3 sm:px-6 py-2 sm:py-3 bg-white/20 backdrop-blur-sm text-white rounded-xl hover:bg-white/30 transition-all duration-200 font-semibold shadow-lg text-xs sm:text-base"
                >
                  <Calendar className="h-4 w-4 sm:h-5 sm:w-5" />
                  <span className="hidden sm:inline">🏋️‍♂️ Δημιουργία Προγράμματος</span>
                  <span className="sm:hidden">🏋️‍♂️ Δημιουργία</span>
                </button>
              </div>
            </div>
