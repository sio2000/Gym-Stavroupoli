...
const TrainerIoanna: React.FC = () => {
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center space-x-3 mb-4">
          <div className="w-10 h-10 bg-pink-100 rounded-full flex items-center justify-center">
            <span className="text-pink-600 font-bold text-lg">Ι</span>
          </div>
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ιωάννα - Pilates Schedule</h1>
      ...
      <PilatesScheduleDisplay
        ...
        title="Πρόγραμμα Pilates - Ιωάννα"
        subtitle=""
      />
    </div>
  );
