-- ============================================================================
-- SAFE SQL: Delete INACTIVE deposits for ilonalovely@hotmail.com
-- Keep only the ACTIVE deposit
-- ============================================================================
-- User: Ιλόνα κερχανατσίδου
-- Email: ilonalovely@hotmail.com
-- Phone: 6988159160
-- Registration: 20 Ιανουαρίου 2026
-- Referral Code: E68574DC
-- ============================================================================
...
WHERE up.email = 'ilonalovely@hotmail.com'
...
WHERE pd.user_id = (SELECT user_id FROM user_data)
  AND pd.is_active = false
RETURNING id, deposit_remaining, is_active, 'DELETED' as action;
