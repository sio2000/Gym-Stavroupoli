#!/usr/bin/env python3
"""
Script to create splash screens from logo for Android app
"""
...
def main():
    print("Creating splash screens for GetFit app...\n")
    ...
    print("3. Launch the app and see your beautiful logo!")
